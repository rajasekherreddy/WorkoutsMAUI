    ...
    public class AndroidNotificationManager : INotificationManager
    {
        ...
        public void SendNotification(string title, string message,int id, DateTime? notifyTime = null)
        {
            ...
            if (notifyTime != null)
            {
              ...
              //  alarmManager.Set(AlarmType.RtcWakeup, triggerTime, pendingIntent);
                ...
                alarmManager.SetInexactRepeating(AlarmType.RtcWakeup, triggerTime, interval, pendingIntent);
        ...
        public void Show(string title, string message)
        {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(AndroidApp.Context, channelId)
                ...
                .SetLargeIcon(BitmapFactory.DecodeResource(AndroidApp.Context.Resources, Resource.Drawable.IconNotification))
